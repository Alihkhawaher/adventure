...
function Update () {
  ...
  var directionToPlayer : Vector3 = 
      Vector3.Scale(XZ, transform.position) - Vector3.Scale(XZ, mainCamera.transform.position);
  ...
  if (Physics.Raycast(mainCamera.transform.position, -Vector3.up, hit)) {
    newCorrection.y = hit.point.y - mainCamera.transform.position.y + adultHeight;
  }
